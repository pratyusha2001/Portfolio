...
const Accomplishments = () => {
    const arr = ["Speaker at an event Sensei, organized by Alexa Developers SRM",
        "Participated in hackathon MOZOHACK organized by SRMkzilla club",
        "Participated in online coding event Code Kaze’21 by Coding Ninjas",
        "Web Development Intern at LetsGrowMore",
        "Completed 100 programs in C Programming under ELAB",
        "Event management in Da Vinci Code organized by Guvi Code Camp SRM"];
    return (
        <div id="accomp">
            <Container>
